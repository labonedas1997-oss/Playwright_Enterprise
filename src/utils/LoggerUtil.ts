...
const currentDir = __dirname; //returns current directory(here its src/utils)
// Go one level above (back to 'src')
const srcDir = path.resolve(currentDir, ".."); //returns current directory's parent directory (src here)

// Change to 'logging' folder
const loggingDir = path.resolve(srcDir, "logging"); //navigates to src/logging
